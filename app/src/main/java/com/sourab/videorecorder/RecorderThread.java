...
public class RecorderThread extends Thread {
  ...
  public void putByteData(SavedFrames lastSavedframe) {
    if (savedFrameList != null) savedFrameList.add(lastSavedframe);
  }
  ...
  private boolean processFramesFromList() {
    ...
    Log.d(RecorderThread.class.getSimpleName(), "savedFrameList: " + savedFrameList.size());
  ...
  private void setFilters() {
    ...
    filterRotateVideoFrontCam =
        new FFmpegFrameFilter(rotateVideoFrontCam, previewWidth, previewHeight);
    filterRotateVideoFrontCam.setPixelFormat(avutil.AV_PIX_FMT_NV21);

    filterRotateVideoBackCam =
        new FFmpegFrameFilter(rotateVideoBackCam, previewWidth, previewHeight);
